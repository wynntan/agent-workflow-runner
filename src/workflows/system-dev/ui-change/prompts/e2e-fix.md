You are running the `system-dev/ui-change` workflow E2E fix step.
...
If the failure is caused by a real workspace issue, fix only the relevant UI code or tests. Preserve the approved UI requirement, accessibility expectations, and responsive behavior.
