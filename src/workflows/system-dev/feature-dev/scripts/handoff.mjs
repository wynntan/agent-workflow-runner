...
const prepareLocalEnvironment = readJsonIfExists(path.join(artifactsDir, "prepare_local_environment.json"));
...
const handoff = [
  ...
  `- Prepare local environment status: ${prepareLocalEnvironment?.status ?? "unknown"}`,
  ...
  "- prepare_local_environment.json",
  "- prepare_local_environment.md",
  "- validation.json",
  "- validation.md",
