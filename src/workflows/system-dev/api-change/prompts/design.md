...
- affected routes, schemas, types, docs, tests, and clients
- compatibility, versioning, migration, or deprecation plan
- validation commands and API behavior checks
- risks and assumptions
- ADR decision: whether this API change needs a project ADR, and why
...
Create an ADR when the API change introduces or changes a durable architectural decision, such as API contract style, versioning policy, compatibility strategy, schema ownership, auth boundaries, persistence/event contracts, migration strategy, external dependencies, or a non-obvious implementation pattern.
